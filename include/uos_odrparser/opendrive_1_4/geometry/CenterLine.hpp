...
struct CenterLine
{
     ...
     * returns a DirectedPoint
     * which contains the position and the tangent vector.
     * If applyLateralOffset is true, it will apply a lateral offset as defined
     * by the lateral offset vector.
     */
    geometry::DirectedPoint eval(double s,
                                 bool applyLateralOffset = true) const;
     ...
     * [0, arclength].
     * The sampling points are optimized depending of the type of geometry of
     * the inner segments.
     */
